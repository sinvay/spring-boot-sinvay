package com.sinvay.boot.authority;

import com.sinvay.boot.authority.anno.SkipAuthority;
import com.sinvay.boot.authority.authentication.Authentication;
import com.sinvay.boot.authority.user.AuthorizedUser;
import com.sinvay.boot.authority.user.UserContextHolder;
import com.sinvay.boot.utils.ApplicationContextHolder;
import com.sinvay.boot.utils.RequestUrlUtils;
...
public class AuthorityInterceptor implements HandlerInterceptor, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        log.debug("<Sinvay Authority> has found <{}> authentications", authenticationMap.size());
    }
